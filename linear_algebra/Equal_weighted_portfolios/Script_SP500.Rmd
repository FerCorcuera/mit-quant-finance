...
```{r }
# 0.0  Load libraries ----
# Loads tidyverse: library that loads a se of packages desiged for data science 
# tidyquant: resource to analzy financial data
#,broom: converts messy data from.R statistical functions into tidy dfs
library(tidyverse)
library(tidyquant)  
library(broom)
```
